...
from Hania.utils.database import get_authuser_names, get_cmode
from Hania.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from Hania.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await hania.stop_stream(message.chat.id)
    except:
        pass

...
from Hania.utils.database.memorydatabase import get_video_limit
from Hania.utils.formatters import convert_bytes
...
async def varsFunc(client, message):
    ...
    s_c = f"[Channel](https://t.me/TechZBots)"
    s_g = f"[Group](https://t.me/TechZBots_Support)"
